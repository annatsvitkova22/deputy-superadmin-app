...
export const environment = {
  ...
  // },
  checkTokenPath: 'https://europe-west3-deputy-app.cloudfunctions.net/checkToken',
  createDeputyPath: 'https://europe-west3-deputy-app.cloudfunctions.net/createCustomUser',
